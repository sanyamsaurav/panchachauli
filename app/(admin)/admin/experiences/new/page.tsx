...
import { uploadAdminImage, createAdminExperience } from "@/api.services/api.services";
...
export default function NewExperiencePage() {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const res = await createAdminExperience(payload);
      if (res.success) {
        toast.success(res.message || "Experience created");
